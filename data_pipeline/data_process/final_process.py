...
def process_unique_points(base_path: str, case_name: str, track_data, shape_prior:bool=False):
...
def visualize_track(base_path: str, case_name: str, track_data):
    object_points = track_data["object_points"]
    object_colors = track_data["object_colors"]
    object_visibilities = track_data["object_visibilities"]
    object_motions_valid = track_data["object_motions_valid"]
...
def get_final_data(base_path: str, case_name: str, shape_prior: bool=False):
    with open(f"{base_path}/{case_name}/track_process_data.pkl", "rb") as f:
        track_data = pickle.load(f)

    track_data = process_unique_points(base_path, case_name, track_data, shape_prior)

    with open(f"{base_path}/{case_name}/final_data.pkl", "wb") as f:
        pickle.dump(track_data, f)

    visualize_track(base_path, case_name, track_data)
