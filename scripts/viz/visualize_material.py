...
from phys_sim import InvPhyTrainerWarp
...
if __name__ == "__main__":
    ...
    optimal_path = f"{DATA_PATH}/experiments_optimization/{case_name}/optimal_params.pkl"
    ...
    best_model_path = glob.glob(f"{DATA_PATH}/experiments/{case_name}/train/best_*.pth")[0]
